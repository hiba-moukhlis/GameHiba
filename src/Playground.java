...
public class Playground {
    ...
    private ArrayList<TrapSprite> traps = new ArrayList<>(); // Liste des pièges
    ...
    public Playground(String pathName) {
        try {
            ...
            final Image imageTrap = ImageIO.read(new File("./img/trap.png")); // Image des pièges
                ...
                for (byte element : line.getBytes(StandardCharsets.UTF_8)) {
                    switch (element) {
                        ...
                        case 'R':
                            ...
                            break;
                        case 'P':
                            TrapSprite trap = new TrapSprite(columnNumber * imageTrapWidth,
    ...
    public ArrayList<TrapSprite> getTraps() {
        return traps;
    }
}
